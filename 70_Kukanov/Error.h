...
//! \brief Перечень возможных ошибок
enum ErrorType {
...
//! \brief Класс, представляющий ошибку
class Error {
private:
...
public:
	...
	*/
	...
	/*! \brief Получить ожидаемое количество столбцов
		\return - ожидаемое количество столбцов
	*/
	int getExpColumnCount() const;
	/*! \brief Получить ожидаемое количество строк
		\return - ожидаемое количество строк
	*/
	int getExpRowCount() const;
	/*! \brief Получить реальное количество столбцов
		\return - реальное количество столбцов
	*/
	int getColumnCount() const;
	/*! \brief Получить реальное количество строк
		\return - реальное количество строк
	*/
	int getRowCount() const;
	/*! \brief Получить номер текущей строки
	...
	*/
	...
	/*! \brief Конструктор для ошибки в количестве элементов в строке
		\param[in] newType - тип ошибки
	...
	*/
	...
	/*! \brief Конструктор для ошибки в элементе матрицы
		\param[in] newType - тип ошибки
